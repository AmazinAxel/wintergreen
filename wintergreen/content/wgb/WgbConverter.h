...
// Convert an opened EPUB book to WGB format using the streaming path.
...
bool convert_epub_to_wgb_streaming(Book& book, const char* output_path, uint8_t* work_buf = nullptr,
